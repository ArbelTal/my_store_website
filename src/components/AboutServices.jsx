...
export default function AboutServices({ lang, t }) {
  return (
    <section className="py-16 md:py-24 border-t border-slate-200 dark:border-cyan-500/10 bg-slate-100/70 dark:bg-slate-950/60 relative transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 hover:border-cyan-500/30 transition shadow-md dark:shadow-xl space-y-4">
