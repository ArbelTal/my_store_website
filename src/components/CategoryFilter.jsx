  ...
  return (
    <div id="catalog" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          <h2 className="text-xl sm:text-3xl font-extrabold text-white flex items-center gap-2.5">
            <LayoutGrid className="h-6 w-6 sm:h-7 sm:w-7 text-cyan-400" />
        ...
        <div className="relative w-full md:w-80">
          <input
            ...
            className="w-full bg-slate-900 border border-slate-800 text-slate-100 text-xs sm:text-sm placeholder-slate-500 rounded-xl py-2.5 sm:py-3 pr-10 pl-4 focus:outline-none focus:border-cyan-500/60 focus:ring-1 focus:ring-cyan-500/60 transition shadow-inner"
          />
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none border-b border-slate-900 mb-3">
        {CATEGORIES.map((cat) => (
          <button
            key={cat.id}
